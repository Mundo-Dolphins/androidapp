...
class EpisodeDaoTest {
    ...
    @Test
    fun `should insert the episodes onto DB`() =
        runTest {
            // Given
    ...
    @Test
    fun `should insert all episodes onto DB`() =
        runTest {
            // Given
    ...
    @Test
    fun `should get an episodes from DB`() =
        runTest {
            // Given
    ...
    @Test
    fun `should get all episode IDs from DB`() =
        runTest {
            // Given
            val episodes = getTestEpisodes(2)
            episodeDao.insertAllEpisodes(episodes)
    ...
    @Test
    fun `should get the latest episodes`() =
        runTest {
            // Given
            val episodes =
                (1..35).map {
    ...
    @Test
    fun `should get all seasons on DB`() =
        runTest {
            // Given
            val episodes =
                (1..10).map {
    ...
    @Test
    fun `should get all episodes from a given season`() =
        runTest {
            // Given
            val episodes = getTestEpisodes(2)
            episodeDao.insertAllEpisodes(episodes)
    ...
    @Test
    fun `should not get any apisode for given season as it's not on DB`() =
        runTest {
    ...
    @Test
    fun getAllEpisodesIdsReturnsEmptyWhenNoData() =
        runTest {
