...
class FakeFeedServiceSuccess : FeedService {
    override suspend fun getAllSeasons(): Response<List<String>> = Response.success(listOf("season_1.json"))
...
class EpisodesViewModelTest {
    @Test
    fun refreshDatabase_success_setsStatusSuccess_and_insertsEpisodes() =
        runTest {
    ...
    @Test
    fun refreshDatabase_empty_setsStatusEmpty() =
        runTest {
    ...
    @Test
    fun refreshDatabase_error_setsStatusError() =
        runTest {
